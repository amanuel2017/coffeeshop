...
//updatePerson();
	...
	private static void getProduct(){
		RestTemplate restTemplate = new RestTemplate();
		Product prod = restTemplate.getForObject(SERVER_URI+"products/351", Product.class);
	...
	private static void createPerson() {
		...
		pers.setEnable(true);
		pers.setEmail("amanuel@gmail.com");
	...
	private static void updatePerson() {
		RestTemplate restTemplate = new RestTemplate();
		Person pers = new Person();
		pers.setFirstName("robel");
		pers.setLastName("woldu");
