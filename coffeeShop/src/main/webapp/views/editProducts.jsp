				...
				<div class="container">
					<div class="row col-md-6 col-md-offset-2 custyle">
						<table class="table table-striped custab">
							<thead>
								<a href="newProduct" class="btn btn-primary btn-xs pull-right"><b>+</b>
									Add new product</a>
								<tr>
									<th>Product Name</th>
									<th>Type</th>
							...
							<c:forEach items="${products}" var="product">
								<tr>
									...
									<td class="text-center"><a href="products/${product.id}"
										class='btn btn-info btn-xs' href="#"><span
											class="glyphicon glyphicon-edit"></span> Edit</a> <a
										href="del/${product.id}" class="btn btn-danger btn-xs"><span
