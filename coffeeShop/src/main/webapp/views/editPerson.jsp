			...
			<div class='navbar-inner nav-collapse'>
				<ul class="nav navbar-nav" style="width: 100%">
					...
					<sec:authorize access="hasRole('ROLE_ADMIN')">
						...
						<li><a href="persons">Edit Person</a></li>
						...
						<div class="col-md-4 col-md-offset-4">
							<div class="panel panel-default">
								<div class="panel-body">
									<h5 class="text-center">Please edit a new User information </h5>
										...
										<div class="form-group">
											...
											<div class="input-group">
												<span class="input-group-addon">First Name</span> <input
													type="text" name="firstName" value="${person.firstName }"
										...
										<div class="form-group">
											...
											<div class="input-group">
												<span class="input-group-addon">Last Name</span> <input
													type="text" name="lastName" value="${person.lastName }"
													class="form-control" autofocus="true" />
											</div>
										</div>
										<div class="form-group">
											<div class="input-group">
												<span class="input-group-addon">Email</span> <input
													type="text" name="email" value="${person.email }"
													class="form-control" />
											</div>
										</div>
										<div class="form-group">
											<div class="input-group">
												<span class="input-group-addon">Phone</span> <input
													type="text" name="phone" value="${person.phone }"
													class="form-control" />
											</div>
										</div>
										<div class="form-group">
											<div class="input-group">
												<span class="input-group-addon">City</span> <input
													type="text" name="city" value="${person.address.city }"
													class="form-control" />
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											<div class="input-group">
												<span class="input-group-addon">State</span> <input
													type="text" name="state" value="${person.address.state }"
													class="form-control" />
											</div>
										</div>
										<div class="form-group">
											<div class="input-group">
												<span class="input-group-addon">Zipcode</span> <input
