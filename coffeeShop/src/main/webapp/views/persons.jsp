				...
				<div class="container">
					<div class="row col-md-6 col-md-offset-2 custyle">
						<table class="table table-striped custab">
							<thead>
								<a href="newPerson" class="btn btn-primary btn-xs pull-right"><b>+</b>
									Add new user</a>
							...
							<c:forEach items="${persons}" var="person">
								<tr>
									...
									<td td class="text-center"><a href="editProfile/${person.id}"
										class='btn btn-info btn-xs' href="#"><span
											class="glyphicon glyphicon-edit"></span> Edit</a> <a
										href="delPerson/${person.id}" class="btn btn-danger btn-xs"><span
